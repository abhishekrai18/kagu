...
import { Box, Divider, Typography, styled, Button, MenuItem, Select } from "@mui/material";
...
const Product = () => {
  ...
  let category = categories.toLowerCase();

  const filteredProducts = categories
    ? products.filter(
        (product) => product.categories.trim() === category.trim()
      )
    : products;
  ...
  return (
    <>
      <Component>
        <Deal>
          <DealText>All {category}S</DealText>
          <Total>({filteredProducts.length} Products)</Total>
          {}
